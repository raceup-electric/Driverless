...
X = xRef[2]   # Initial X position of the vehicle
Y = yRef[2]   # Initial Y position slightly off the path
...
# Run the simulation
while True:
    steering_angle = controller.controller_stanley(X, Y, Theta, vel, clk)
