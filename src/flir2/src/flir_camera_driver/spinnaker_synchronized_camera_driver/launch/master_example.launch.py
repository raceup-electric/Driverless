...
cam_parameters = {
    ...
    'exposure_auto': 'Off',
    'exposure_time': 15000,  # not used under auto exposure
    'trigger_mode': 'On',
    'gain_auto': 'Off',
    ...
    return LaunchDescription(
        [
            ...
            LaunchArg(
                ...
                default_value='/home/stego/flir2/src/flir_camera_driver/spinnaker_synchronized_camera_driver/launch/calibration_directory/',
